...
type
  ...
  TfrmMain = class(TForm)
    ...
    lblPort: TLabel;
    lblHost: TLabel;
    mnuTestResumeTorrent: TMenuItem;
    mnuTestResumeTorrentsAll: TMenuItem;
    mnuTestPauseTorrent: TMenuItem;
    mnuTestPauseTorrentsAll: TMenuItem;
    mnuTestSep1: TMenuItem;
