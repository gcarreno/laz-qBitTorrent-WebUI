...
Master: [![Build Status](https://travis-ci.org/gcarreno/laz-qBitTorrent-WebUI.svg?branch=master)](https://travis-ci.org/gcarreno/laz-qBitTorrent-WebUI)

Devel: [![Build Status](https://travis-ci.org/gcarreno/laz-qBitTorrent-WebUI.svg?branch=devel)](https://travis-ci.org/gcarreno/laz-qBitTorrent-WebUI)
